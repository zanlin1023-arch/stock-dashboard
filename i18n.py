...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "nav_watchlist": {"ko": "⭐ 관심 종목", "zh-TW": "⭐ 觀察清單"},
    ...
    "btn_watchlist_short": {"ko": "⭐ 관심", "zh-TW": "⭐ 觀察"},
    ...
    "target_v": {"ko": "1차 익절", "zh-TW": "首階段獲利"},
    "target_n": {"ko": "표준 목표", "zh-TW": "標準目標"},
    "target_e": {"ko": "강세 목표", "zh-TW": "強勢目標"},
    ...
    "add_to_watch": {"ko": "⭐ 관심 종목 추가", "zh-TW": "⭐ 加入觀察清單"},
    "add_to_watch_done": {"ko": "✅ 관심 종목에 추가됨", "zh-TW": "✅ 已加入觀察清單"},
    ...
    "exclude_watchlist": {"ko": "관심 종목 제외", "zh-TW": "排除觀察清單"},
    ...
    # ⭐ 관심 종목 페이지
    # ════════════════════════════════
    "watchlist_title": {"ko": "⭐ 관심 종목", "zh-TW": "⭐ 觀察清單"},
    "watchlist_add": {"ko": "➕ 관심 종목 추가", "zh-TW": "➕ 新增觀察"},
    "tags_optional": {"ko": "태그 (쉼표 구분, 선택)", "zh-TW": "標籤 (以逗號分隔, 選填)"},
    "watchlist_empty": {
        "ko": "관심 종목이 없습니다. 위에서 추가하거나 종목 분석 화면에서 ⭐ 버튼으로 추가하세요.",
        "zh-TW": "尚無觀察個股。請從上方新增或在分析頁面按 ⭐ 按鈕。",
    },
    "watchlist_list": {"ko": "📋 관심 목록", "zh-TW": "📋 觀察清單"},
