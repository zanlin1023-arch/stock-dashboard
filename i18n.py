...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "nav_my_stocks": {"ko": "📁 내 종목", "zh-TW": "📁 我的個股"},
    # 📁 내 종목 (통합 페이지)
    "mystocks_filter_all": {"ko": "전체", "zh-TW": "全部"},
    "mystocks_filter_holdings": {"ko": "💼 보유만", "zh-TW": "💼 僅持股"},
    "mystocks_filter_watchlist": {"ko": "⭐ 관심만", "zh-TW": "⭐ 僅自選"},
    "mystocks_type": {"ko": "유형", "zh-TW": "類型"},
    "mystocks_type_holding": {"ko": "💼 보유", "zh-TW": "💼 持股"},
    "mystocks_type_watch": {"ko": "⭐ 관심", "zh-TW": "⭐ 自選"},
    "mystocks_add_section": {"ko": "➕ 종목 추가", "zh-TW": "➕ 新增個股"},
    "mystocks_add_type": {"ko": "유형 선택", "zh-TW": "選擇類型"},
    "mystocks_convert_section": {"ko": "🔄 유형 전환 (보유 ↔ 관심)", "zh-TW": "🔄 類型轉換 (持股 ↔ 自選)"},
    "mystocks_convert_target": {"ko": "전환할 종목", "zh-TW": "選擇個股"},
    "mystocks_edit_section": {"ko": "✏️ 수량/평단 수정", "zh-TW": "✏️ 修改數量/均價"},
    "mystocks_edit_target": {"ko": "수정할 종목", "zh-TW": "選擇個股"},
    "mystocks_edit_empty": {"ko": "보유 종목이 없습니다.", "zh-TW": "尚無持股。"},
    "mystocks_edited": {"ko": "✅ 수정 완료", "zh-TW": "✅ 修改完成"},
    "btn_save": {"ko": "💾 저장", "zh-TW": "💾 儲存"},
    "mystocks_convert_to_holding": {"ko": "→ 💼 보유로 전환 (평단/수량 필요)", "zh-TW": "→ 💼 轉為持股"},
    "mystocks_convert_to_watch": {"ko": "→ ⭐ 관심으로 전환", "zh-TW": "→ ⭐ 轉為自選"},
    "mystocks_converted": {"ko": "✅ 전환 완료", "zh-TW": "✅ 轉換完成"},
    "mystocks_holdings_count": {"ko": "보유 종목 수", "zh-TW": "持股檔數"},
    ...
    # 일목 매수 시그널 (추천/관심 공용)
    "ichimoku_col": {"ko": "일목", "zh-TW": "一目"},
    "ichimoku_fresh": {"ko": "🔥 매수돌파", "zh-TW": "🔥 突破買進"},
    "ichimoku_strong_buy": {"ko": "🟢 삼역호전", "zh-TW": "🟢 三役好轉"},
    "ichimoku_buy": {"ko": "✅ 매수우호", "zh-TW": "✅ 偏多"},
    ...
    "ichimoku_hammer": {"ko": "💡망치", "zh-TW": "💡錘子"},
    ...
    "hist_col_price": {"ko": "분석시점가", "zh-TW": "分析時點價"},
    "hist_col_avg_price": {"ko": "💰 내 평단가", "zh-TW": "💰 我的均價"},
    "hist_col_pnl": {"ko": "평단 대비", "zh-TW": "對均價"},
